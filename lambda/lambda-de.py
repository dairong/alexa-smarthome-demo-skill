...
SAMPLE_APPLIANCES = [
    ...
    },
    {
        ...
        'version': '1',
        'friendlyName': 'Dimmer',
        'friendlyDescription': 'Dimmer - funktional und erreichbar',
        'isReachable': True,
        'actions': [
            'turnOn',
            'turnOff',
    ...
    },
    {
        ...
        'modelName': 'Fan',
        'version': '1',
        'friendlyName': 'Ventilator',
        'friendlyDescription': 'Ventilator - funktional und erreichbar',
        'isReachable': True,
        'actions': [
            'turnOn',
            'turnOff',
    ...
    },
    {
        ...
        'modelName': 'Switch',
        'version': '1',
        'friendlyName': 'Unerreichbarer Schalter',
        'friendlyDescription': 'Schalter - unerreichbar und zeigt (offline)',
        'isReachable': False,
        'actions': [
            'turnOn',
            'turnOff',
    ...
    },
    {
        ...
        'friendlyDescription': 'Thermostat im AUTO-Modus und erreichbar',
        'isReachable': True,
        'actions': [
    ...
    },
    {
        ...
        'friendlyDescription': 'Thermostat im HEAT-Modus und erreichbar', 
        'isReachable': True,
        'actions': [
            'setTargetTemperature',
            'incrementTargetTemperature',
    ...
    },
    {
        ...
        'version': '1',
        'friendlyName': 'Kühler',
        'friendlyDescription': 'Thermostat im COOL-Modus und erreichbar', 
        'isReachable': True,
        'actions': [
            'setTargetTemperature',
            'incrementTargetTemperature',
    ...
    },
    {
        ...
        'modelName': 'Thermostat',
        'version': '1',
        'friendlyName': 'Sparendes Thermostat',
        'friendlyDescription': 'Thermostat im ECO-Modus und erreichbar',
        'isReachable': True,
        'actions': [
            'setTargetTemperature',
            'incrementTargetTemperature',
    ...
    },
    {
        ...
        'modelName': 'Thermostat',
        'version': '1',
        'friendlyName': 'Manuelles Thermostat',
        'friendlyDescription': 'Thermostat im CUSTOM-Modus und erreichbar',
        'isReachable': True,
        'actions': [
            'setTargetTemperature',
            'incrementTargetTemperature',
    ...
    },
    {
        ...
        'modelName': 'Thermostat',
        'version': '1',
        'friendlyName': 'Ausgeschaltetes Thermostat', # 
        'friendlyDescription': 'Thermostat im OFF-Modus und erreichbar',
        'isReachable': True,
        'actions': [
            'setTargetTemperature',
            'incrementTargetTemperature',
    ...
    },
    {
        ...
        'modelName': 'Lock',
        'version': '1',
        'friendlyName': 'Schloss',
        'friendlyDescription': 'Schloss - funktional und erreichbar',
        'isReachable': True,
        'actions': [
            'setLockState',
            'getLockState',
        ...
        if error in ['UnableToGetValueError','UnableToSetValueError']:
            ...
            for code in VALID_UNABLE_ERROR_INFO_CODES:
                ...
                if error == 'UnableToGetValueError':
                    friendly_description = 'Utterance: Alexa, ist ' + friendly_name + ' verschlossen? Antwort: ' + error + ' code: ' + code
                else:
                    friendly_description = 'Utterance: Alexa, verschließe ' + friendly_name + '. Antwort: ' + error + ' code: ' + code  
            ...
            for code in VALID_CURRENT_DEVICE_MODES:
                ...
                friendly_description = 'Utterance: Alexa, schalte ' + friendly_name + ' an. Antwort: ' + error + ' code: ' + code
                if code == 'COLOR':
                    model_name = 'Light'
                else:
                    model_name = 'Switch'
            ...
            friendly_name = generateErrorFriendlyName(device_number)
            friendly_description = 'Utterance: Alexa, schalte ' + friendly_name + ' an. Antwort: ' + error    
            ...
            if error == 'ValueOutOfRangeError':
                sample_error_appliance['friendlyDescription'] = 'Utterance: Alexa, stelle ' + friendly_name + ' auf 23 Grad. Antwort: ' + error
...
def generateErrorFriendlyName(device_number):
    return 'Gerät ' + str(device_number)
